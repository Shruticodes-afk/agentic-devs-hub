      ...
      <Card className="w-full max-w-sm relative z-10 border-white/[0.08] bg-card shadow-2xl shadow-black/50">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-muted-foreground text-sm">
            Sign in to the Agentic Devs Collective Hub
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {message && (
            <div className="p-3 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm text-center">
              {message}
            </div>
          )}
          ...
          <Button
            ...
            className="w-full border-white/[0.08] hover:bg-white/[0.04] transition-colors duration-200"
          >
