...
import { Search, ExternalLink, BookOpen, LayoutTemplate, Presentation, Link as LinkIcon, Sparkles } from "lucide-react";
          ...
          {filteredResources.map((resource) => (
            ...
            >
              ...
              <div className="mt-auto pt-2 flex flex-wrap gap-2 items-center">
                ...
                {resource.ai_tagged && (
                  <span 
                    title="Metadata automatically generated by AI"
                    className="ml-auto flex items-center text-[10px] uppercase font-bold tracking-wider text-purple-400 bg-purple-400/10 px-2 py-1 rounded-full border border-purple-400/20"
                  >
                    <Sparkles className="w-3 h-3 mr-1" /> AI Tagged
                  </span>
                )}
              </div>
            </a>
